    ...
    <div>
      ...
      >
        <label className="radio">
          <input
            ...
            checked=""
          />
          <span className="radio-name">All</span>
        </label>
        {obj2.map((ele) => {
          return (
            <label className="radio">
              <input
                ...
                name="radio"
              />
              <span className="radio-name">{ele}</span>
            </label>
          );
        })}
      </div>
      <div>
        {filteredList.map((obj, index) => {
          return (
            <div
              className="product flex font-sans"
              key={index}
            >
              ...
              <div className="product-info flex-auto p-6">
                <Link
                  to={`/product/${obj.id}`}
                  className="product-name flex-auto text-lg font-semibold text-slate-900"
                >
                  {obj.name}
                </Link>
                ...
                <div class="flex space-x-4 mb-6 text-sm font-medium">
                  <div class="buy-add-btn flex-auto flex space-x-4">
                    <button
